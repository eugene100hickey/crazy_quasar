---
title: Tennis Sets - Jimmy's Theorem
author: eugene100hickey
date: '2020-09-14'
slug: tennis-sets-jimmy-s-theorem
categories: []
tags: []
---
...
setwd("~/Desktop/Academic/Research/Blogs/Tennis/files")
...
#load in atp files
atp <-
  list.files(pattern="https://raw.githubusercontent.com/eugene100hickey/crazy_quasar/master/content/post/data/*.csv") %>% 
  map_df(~read.csv(.)) %>% 
  as_tibble()
```
