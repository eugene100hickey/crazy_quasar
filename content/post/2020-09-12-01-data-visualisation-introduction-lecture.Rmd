---
title: 01 Data Visualisation Introduction Lecture
author: eugene100hickey
date: '2020-09-12'
slug: 01-data-visualisation-introduction-lecture
categories: []
tags: []
output:
...
<img src="/post/images/rstudio.PNG" height="600px" width="800px" align="center"/> 
...
- [Bioconductor](www.bioconductor.org)
    ...
    - then *install("some_genomics_package")* to use
...
- github
    ...
    - then *install_github("developer_name/package_name")*
...
<img src="/post/images/hadley.jpg" height="100px" width="100px" align="right"/>
...
<img src="/post/images/hillary.jpeg" height="100px" width="100px" align="right"/>
...
<img src="/post/images/rafael.jpg" height="100px" width="100px" align="right"/>
...
- Do a datacamp course every week
...
- you'll need to create an account at datacamp.com and send me the email you'll use for this account
   - I can check your progress on datacamp courses
...
africa <- suppressMessages(readOGR(dsn = "Africa", layer = "Africa"))
...
dublin <- get_map(location = "dublin", zoom = 11, maptype = "watercolor")

# SZ Brain data

url <- "https://www.ncbi.nlm.nih.gov/pmc/articles/PMC5918692/bin/NIHMS958804-supplement-Supplementary_Table.xlsx"
suppressMessages(GET(url, write_disk(temp_file <- tempfile(fileext = ".xlsx")))) # downloads the .xlsx file
...
knots_data$image <- "/home/eugene/Desktop/Academic/SciencePG/DataVis/lectures/2020/images/knotweed1.jpg"
ggmap(dublin) + 
  geom_image(data = knots_data, aes(lon, lat, image = image), size = 0.05) + 
...
# downloads tweets
token <- get_token()
greens <- search_tweets(q= search_term, n=1000, 
                       geocode = "53.33,-6.25,100mi",
                       token = token)
